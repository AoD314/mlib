    ...
    public:
        ...
        inline void start()
        {
            ...
            asm volatile(
                ...
                "mov %%edx, %0\n\t"
                "mov %%eax, %1\n\t"
                : "=r"(time_edx), "=r"(time_eax)::"%rax", "%rbx", "%rcx", "%rdx");
#endif
        }
        ...
        inline void stop()
        {
            ...
            asm volatile(
                ...
                "mov %%eax, %1\n\t"
                "cpuid\n\t"
                : "=r"(time_edx1), "=r"(time_eax1)::"%rax", "%rbx", "%rcx", "%rdx");
#endif

            time_last = (static_cast<unsigned long long>(time_edx1) << 32 | static_cast<unsigned long long>(time_eax1))
